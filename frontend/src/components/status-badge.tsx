...
type StatusValue = "active" | "paused" | "limited" | "reserved" | "exceeded" | "deactivated";
...
const statusClassMap: Record<StatusValue, string> = {
  ...
  reserved: "bg-orange-500/15 text-orange-700 border-orange-500/20 hover:bg-orange-500/20 dark:text-orange-400",
