...
class DashboardSettingsResponse(DashboardModel):
    ...
    quota_reserve_primary_percent: float = Field(ge=0.0, le=100.0)
    quota_reserve_secondary_percent: float = Field(ge=0.0, le=100.0)
...
class DashboardSettingsUpdateRequest(DashboardModel):
    ...
    quota_reserve_primary_percent: float | None = Field(default=None, ge=0.0, le=100.0)
    quota_reserve_secondary_percent: float | None = Field(default=None, ge=0.0, le=100.0)
