...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("quotaReserveEnabled", True, "quota_reserve_enabled"),
        ("quotaReservePrimaryPercent", 3.0, "quota_reserve_primary_percent"),
        ("quotaReserveSecondaryPercent", 1.0, "quota_reserve_secondary_percent"),
